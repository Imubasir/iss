...
<head>
  ...
  <title>ISS | Courses/Subjects</title>
  <!-- base:css -->
...
<body>
  <div class="container-scroller d-flex">
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      <ul class="nav">
        ...
        <li class="nav-item active" id="sett_courses">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="navbar col-lg-12 col-12 px-0 py-0 py-lg-4 d-flex flex-row">
        <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
          ...
          <h4 class="font-weight-bold mb-0 d-none d-md-block mt-1" id="logged_name"> Courses/Subjects</h4>
        ...
        <div class="content-wrapper">
          <div class="card">
            <div class="card-header">
              <span style="float: right;"><button type="button" class="btn btn-primary btn-md btn-block" data-toggle="modal" data-target = "#addCourse_modal"><i class="mdi mdi-playlist-plus"></i> Add Course</button></span>
  ...
  <!-- Add Course Modal -->
  <div class="modal fade" id="addCourse_modal">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="addCourse_form" class="forms-sample">
            <div class="form-group">
              <label for="prog_title">Code</label>
              <input type="text" class="form-control form-control-sm" name="course_code" id="course_code">
            </div>

            <div class="form-group">
              <label for="prog_title">Title</label>
              <input type="text" class="form-control form-control-sm" name="course_title" id="course_title">
            </div>

            <div class="form-group">
              <label for="prog_title">Credits</label>
              <input type="number" class="form-control form-control-sm" name="course_credit" id="course_credit">
            </div>

            <div class="form-group">
              <label for="prog_duration">Level</label>
            ...
            <div class="form-group">
              <label for="prog_department">Programme</label>
              <select class="form-control" name="course_programme" id="course_programme">
        ...
        <div class="modal-footer">
          <button class="btn btn-sm btn-primary" onclick="addCourse ()"><i class="mdi mdi-content-save"></i> Save </button>
        </div>
      </div>
      <!-- /.modal-content -->
    </div>
  ...
  <div class="modal fade" id="editCourse_modal">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="editCourse_form" class="forms-sample">
            <div class="form-group">
              <label for="prog_title">Code</label>
              <input type="text" class="form-control form-control-sm" name="edit_course_code" id="edit_course_code">
            </div>

            <div class="form-group">
              <label for="prog_title">Title</label>
              <input type="text" class="form-control form-control-sm" name="edit_course_title" id="edit_course_title">
            </div>

            <div class="form-group">
              <label for="prog_title">Credits</label>
              <input type="number" class="form-control form-control-sm" name="edit_course_credit" id="edit_course_credit">
            </div>

            <div class="form-group">
              <label for="prog_duration">Level</label>
              <select class="form-control" name="edit_course_level" id="edit_course_level">
                <option selected disabled>Select Level</option>
                <option value="100">100</option>
                <option value="200">200</option>
                <option value="300">300</option>
            ...
            <div class="form-group">
              <label for="prog_department">Programme</label>
              <select class="form-control" name="edit_course_programme" id="edit_course_programme">
        ...
        <div class="modal-footer">
          <button class="btn btn-sm btn-primary" id="editCourseBtn"><i class="mdi mdi-content-save"></i> Save </button>
        </div>
      </div>
      <!-- /.modal-content -->
    </div>
