        ...
        <li class="nav-item active keep-open">
          ...
          <div class="collapse" id="auth">
            <ul class="nav flex-column sub-menu">
              ...
              <li class="nav-item active" id="std_courses"> <a class="nav-link" href="./"> Courses </a></li>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="navbar col-lg-12 col-12 px-0 py-0 py-lg-4 d-flex flex-row">
        <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
          ...
          <h4 class="font-weight-bold mb-0 d-none d-md-block mt-1" id="logged_name"> Student Courses</h4>
        ...
        <div class="content-wrapper">
          <div class="card">
            <div class="card-header">
              <!-- <span style=""><button class="btn btn-md btn-info">Custom Search</button></span> -->
              <h5>Courses List</h5>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-hover table-striped" id="course_tbl">
                  <thead>
                    <th>##</th>
                    <th>Code</th>
                    <th>Title</th>
