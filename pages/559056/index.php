        ...
        <li class="nav-item active keep-open">
          ...
          <div class="collapse" id="result">
            <ul class="nav flex-column sub-menu">
              ...
              <li class="nav-item active" id="signatory"> <a class="nav-link" href="./"> Signatory </a></li>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="navbar col-lg-12 col-12 px-0 py-0 py-lg-4 d-flex flex-row">
        <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
          ...
          <h4 class="font-weight-bold mb-0 d-none d-md-block mt-1" id="logged_name"> Transcript Signitory</h4>
            ...
            <div class="card-header">
                ...
                <div class="dropdown">
                  <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Action
                    ...
                    <ul class="dropdown-menu">
                      <li><a class='dropdown-item' href="#" data-toggle="modal" data-target="#signatory_modal">Add Signatory</a></li>
                    </ul>
                  </div>
                </span>
              ...
              <div class="card-body">
                <div class="responsive">
                  <table class="table table-hover table-striped" id="sig_tbl">
                    <thead>
                      <tr>
                        <th>Sn</th>
                        <th>Name</th>
                    ...
                    <tbody id="sig_body" style="text-transform: uppercase;">
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title">Add New Signatory</h4>
                  <button class="btn btn-inverse-secondary btn-fw close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                <div class="modal-body">
                  <form id="signatory_form" class="forms-sample">
                   <div class="form-group">
                    <label for="staff_name">Name</label>
                    <input type="text" class="form-control form-control-sm" name="signatory_name" id="signatory_name">
                  </div>

                  <div class="form-group">
                    <label for="username">Designation</label>
                    <input type="text" class="form-control form-control-sm" name="signatory_desig" id="signatory_desig">
                  </div>
                </form>
              </div>
              <div class="modal-footer">
                <button class="btn btn-sm btn-primary" onclick="add_signatory()"><i class="mdi mdi-content-save"></i> Save </button>
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
