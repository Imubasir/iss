  ...
  <div class="container-scroller d-flex">
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      <ul class="nav">
        ...
        <li class="nav-item">
          <a class="nav-link" data-bs-toggle="collapse" href="#home" aria-expanded="false" aria-controls="home" id="home_menu">
        ...
        <li class="nav-item">
          <a class="nav-link" data-bs-toggle="collapse" href="#auth" aria-expanded="false" aria-controls="auth" id="student_menu">
        ...
        <li class="nav-item">
          <a class="nav-link" data-bs-toggle="collapse" href="#result" aria-expanded="false" aria-controls="result" id="services_menu">
        ...
        <li class="nav-item active" id="log">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="navbar col-lg-12 col-12 px-0 py-0 py-lg-4 d-flex flex-row">
        <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
          ...
          <h4 class="font-weight-bold mb-0 d-none d-md-block mt-1" id="logged_name"> Log</h4>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="responsive">
                <table class="table table-hover table-striped" id="log_tbl">
                  <thead>
                    <th>#</th>
                    <th>Activity</th>
                    <th>Performed By</th>
