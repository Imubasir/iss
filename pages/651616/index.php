  ...
  <div class="container-scroller d-flex">
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      <ul class="nav">
        ...
        <li class="nav-item active" id="sett_notification">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="navbar col-lg-12 col-12 px-0 py-0 py-lg-4 d-flex flex-row">
        <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
          ...
          <h4 class="font-weight-bold mb-0 d-none d-md-block mt-1" id="logged_name"> Notifications</h4>
        ...
        <div class="content-wrapper">
          <div class="card">
            <div class="card-header">
              <span style="float: right;"><button type="button" class="btn btn-primary btn-md btn-block" data-toggle="modal" data-target = "#notification_modal"><i class="mdi mdi-bell"></i> Send Notification</button></span>
              <div class="card-title">Notifications List</div>
            </div>
            <div class="card-body">
              <div class="responsive">
                <table class="table table-hover table-striped" id="notify_tbl">
                  <thead>
                    <th>##</th>
                    <th>Title</th>
                    <th>Date Sent</th>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="notification_form" class="forms-sample">

            <div class="form-group">
              <label for="notification_title">Title</label>
              <input type="text" class="form-control form-control-sm" name="notification_title" id="notification_title">
            </div>

            <div class="form-group">
              <label for="notification">Message</label>
              <textarea class="form-control" name="notification" id="notification" rows="4"></textarea>
            </div>    
        ...
        <div class="modal-footer">
          <button class="btn btn-sm btn-primary" onclick="addNotification()">Send <i class="mdi mdi-send"></i></button>
        </div>
      </div>
      <!-- /.modal-content -->
    </div>
  ...
  <div class="modal fade" id="edit_notification_modal">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="edit_notification_form" class="forms-sample">

            <div class="form-group">
              <label for="notification_title">Title</label>
              <input type="text" class="form-control form-control-sm" name="edit_notification_title" id="edit_notification_title">
            </div>

            <div class="form-group">
              <label for="notification">Message</label>
              <textarea class="form-control" name="edit_notification" id="edit_notification" rows="4"></textarea>
            </div>    
        ...
        <div class="modal-footer">
          <button class="btn btn-sm btn-primary" id="updateNotify">Send <i class="mdi mdi-send"></i></button>
        </div>
      </div>
      <!-- /.modal-content -->
    </div>
