        ...
        <li class="nav-item active keep-open">
          ...
          <div class="collapse" id="result">
            <ul class="nav flex-column sub-menu">
              ...
              <li class="nav-item active" id="requests"> <a class="nav-link" href="./"> Requests </a></li>
            </ul>
          </div>
        </li>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="navbar col-lg-12 col-12 px-0 py-0 py-lg-4 d-flex flex-row">
        <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
          ...
          <h4 class="font-weight-bold mb-0 d-none d-md-block mt-1" id="logged_name"> Transcript Requests</h4>
        ...
        <div class="content-wrapper">
          <div class="card mb-3 animated fadeInRight">
            <div class="card-header">
              <b>Requests List</b>
              <span style="float: right"><button class="btn btn-md btn-info" data-toggle="modal" data-target="#requestModal">Add Request</button></span>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-hover table-striped" id = "request_tbl">
                  ...
                  <tbody id="request_body" style="text-transform: uppercase;">
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="reqForm">
                  ...
                  <div class="form-group">
                    <div class="form-label-group">
                      ...
                      <input type="text" id="student_prog" name="student_prog" class="form-control" readonly="">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control custom-select" id="service_type" name="service_type">
                      ...
                      <?php
                      $select = "SELECT * FROM iss_services";
                      $rs = mysqli_query($link, $select);
                      if($rs) {
                        while($row = mysqli_fetch_assoc($rs)) {
                          ?>
                          <option value="<?php echo $row['service_code'] ?>"><?php echo $row['service_name'] ?></option>
                          <?php
                        }
                      }
                      ?>
                  ...
                  <div class="form-group" id="trans_q">
                    <div class="form-label-group">
                      <label>Transcript Copies</label>
                      <input type="number" name="service_copies" class="form-control">
                    </div>
                  </div>
              ...
              <div class="modal-footer">
                ...
                <button onclick="addRequest()" class="btn btn-primary btn-sm">Add Request</button>
